  ...
  return (
    <div className='page-wrap'>
      <div className={classes.root}>
        ...
        <h3>{dishECount}</h3>
        <ButtonGroup size="small" color='primary' aria-label="small contained primary button group">
        ...
        <h4> You will receive an AC/Heater allowance of 10 hours per week, earn 3 points for each hour under and lose 3 points for each hour over </h4>

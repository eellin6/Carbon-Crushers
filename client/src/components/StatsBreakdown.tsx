...
const StatsBreakdown = (): React.ReactElement => {
  return (
    <div className='page-wrap'>
      ...
      <img className='badge-img-breakdown' src='https://i.ibb.co/gV9qFwy/badges-power-puncher.png' />
      <h2>Energy</h2>
      ...
      <img className='badge-img-breakdown' src='https://i.ibb.co/R7hztRy/badges-water-wizard.png' />
      <h2>Water</h2>
      ...
      <img className='badge-img-breakdown' src='https://i.ibb.co/C2by1fr/badges-rockin-recycler.png' />
      <h2>Recycling</h2>
      <h4>You will earn 1 point for every bottle recycled. Upload a picture and your points will increase by 50% per bottle.</h4>
      <img className='badge-img-breakdown' src='https://i.ibb.co/syFp2sB/badges-veggie-victor.png' />
      ...
      <img className='badge-img-breakdown' src='https://i.ibb.co/z8LKZHZ/badges-road-warrior.png' />
      <h2>Mileage</h2>
